...
# Powered by GPT-5.2 with full application context
...
⚠️ IMPORTANT: L'utilisateur ne peut pas utiliser "Save to Github" d'Emergent.
Workflow manuel:
...
class NatiFenuaAIAgent:
    ...
    async def send_message(self, session_id: str, user_message: str, context: Optional[str] = None) -> dict:
        ...
        try:
            ...
            # Add context if provided (e.g., error logs, code snippets)
