...
# WHITELIST ONLY - Required for cookies (withCredentials=true, SameSite=None)
...
# SINGLE CORS configuration - credentials require explicit origins (not "*")
app.add_middleware(
    CORSMiddleware,
...
# Explicit OPTIONS handler for CORS preflight (fixes 400 errors)
