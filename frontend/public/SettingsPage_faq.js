        ...
        <div>
          ...
          <div className={`rounded-xl overflow-hidden ${isDark ? 'bg-[#16213E]' : 'bg-white'} shadow-sm`}>
            ...
            >
              ...
              <div className="flex-1 text-left">
                <p className={`font-medium ${isDark ? 'text-white' : 'text-gray-900'}`}>RGPD & Confidentialite</p>
                <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Vos donnees et vie privee</p>
              </div>
              <ChevronRight className={isDark ? 'text-gray-500' : 'text-gray-400'} size={20} />
            </button>
            ...
            >
              <div className={`p-2 rounded-lg ${isDark ? 'bg-blue-500/20' : 'bg-blue-100'}`}>
                <HelpCircle className={isDark ? 'text-blue-400' : 'text-blue-500'} size={20} />
              </div>
              <div className="flex-1 text-left">
                <p className={`font-medium ${isDark ? 'text-white' : 'text-gray-900'}`}>FAQ & Aide</p>
                <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Questions frequentes</p>
              </div>
              <ChevronRight className={isDark ? 'text-gray-500' : 'text-gray-400'} size={20} />
            </button>
          </div>
