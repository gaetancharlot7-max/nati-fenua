...
const NotificationSettingsPage = () => {
  ...
  const notificationTypes = [
    ...
    },
    {
      ...
      icon: Megaphone,
      title: 'Promotions',
      description: 'Offres spéciales et actualités de My Fenua',
      ...
      >
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Activez les notifications pour ne rien manquer de ce que vos amis partagent sur My Fenua
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-[#00CED1] to-[#006994] rounded-2xl p-6 text-white">
          ...
          <p className="text-white/80 text-sm mb-4">
            Installez My Fenua sur votre téléphone pour recevoir des notifications même quand l'app est fermée
          </p>
          <Button
            onClick={() => {
